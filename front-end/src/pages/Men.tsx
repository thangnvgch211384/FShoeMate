...
export default function Men() {
  ...
  // Calculate category counts based on all products (for male targetAudience)
  // This shows the actual count of products in each category for Men's page
  const categoryCounts = useMemo(() => {
    const counts: Record<string, number> = {}
    // Count products from allProducts (all male products) to get accurate category counts
